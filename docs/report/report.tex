...
\subsection{Dataset Source}
   ...
   \textit{High Resolution} Our dataset is recorded by $1080P$ camera. The keyboard resolution increased by $70\%$ than the previous dataset.
...
\subsection{Dataset Preprocessing}
   ...
   1. midi convertion and generation
