...
In the very early stage, we used the raw dataset to feed the model during training and got following result:\\
...
We have reached \(95\%+\) accuracy on both black keys and white keys after applying the preprocessing mentioned above. 
...
\begin{tabular}{ccccc}
   ...
   \midrule
   \textbf{Bundle-B} &98.8 \%& 99.5 \%&99.1\%& 99.1\%\\
   \textbf{Bundle-W} &95.7 \%& 97.1 \%&96.4\%& 96.4\%\\
   \textbf{Single-B} &98.2 \%& 99.2 \%&98.7\%& 93.7\%\\
   \textbf{Single-W} &92.6 \%& 95.0 \%&93.7\%& 93.8\%\\
   \bottomrule
   \end{tabular}
