...
% Todo: Velocity Evaluation & Results
%
...
\subsection{Hyperparameter Tuning}
   ...
   On all models are trained \(20\) epoches with Adam optimizer with learning rate \(5e-4\) and a decay of \(\gamma=0.05\) for every 10 epochs. 
