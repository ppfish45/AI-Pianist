...
To achieve our goals of keyboard localization, key detection and velocity detection, we will build and tune several seperate networks. Details are covered in section 3.
